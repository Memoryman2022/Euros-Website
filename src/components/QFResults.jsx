  ...
  useEffect(() => {
    const fetchResults = async () => {
      try {
        ...
        // Filter results for Quarter Finals
        const quarterFinals = resultsData.filter((result) =>
          result.gameId.startsWith("Q")
        );

        setResults(quarterFinals);
      } catch (error) {
...
export default QuarterFinalResults;
